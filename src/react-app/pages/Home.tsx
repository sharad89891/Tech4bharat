  ...
  const testimonials = [
    {
      ...
      content: "The Tech For Bharat workshop completely transformed my understanding of AI applications in India. The hands-on approach and expert guidance helped me build my first AI model.",
      avatar: "PS"
    },
    {
      name: "Rahul Verma",
      ...
      content: "The internship program at VJTI's AI Lab was an incredible experience. I worked on real-world projects that are making a difference in healthcare accessibility across rural India.",
      avatar: "RV"
    },
    {
      name: "Anjali Patel",
      ...
      content: "Tech For Bharat's focus on 'Made in India, Made for India' solutions inspired my research in agricultural AI. The mentorship I received was invaluable for my career.",
      avatar: "AP"
    }
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-100 text-amber-800 text-sm font-semibold mb-6 animate-pulse">
                ...
                <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-white/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">COEP Tech University, Pune</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/register" 
                  className="px-8 py-4 bg-gradient-to-r from-amber-500 to-yellow-500 text-white rounded-full font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
                  Register Now
                </Link>
                <Link 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-white/30">
                ...
                <div className="text-gray-700 font-medium">Cities Reached</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Through comprehensive programs, workshops, and internships, we're creating opportunities for students to learn, innovate, and lead in the technology sector. We focus on "Made in India, Made for India" solutions that address our nation's unique challenges and opportunities.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Our programs cover cutting-edge technologies including Artificial Intelligence, Deep Learning, Generative AI, Computer Vision, and Natural Language Processing, preparing students for the future of technology in India.
                </p>
                <Link 
                  to="/about" 
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <div className="absolute -top-6 -left-6 w-full h-full bg-gradient-to-br from-purple-500 to-amber-500 rounded-2xl"></div>
                  <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4">
                        <div className="text-2xl font-bold text-amber-600 mb-1">ML</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-amber-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">Learn about our national initiative</p>
              </Link>
              
              <Link 
                to="/previous-workshop" 
                className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-6 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-amber-100"
              >
              ...
              >
                ...
                <p className="text-gray-600 text-sm">View our VJTI AI internship</p>
              </Link>
